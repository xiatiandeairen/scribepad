/* ═══ Spec Plan — 文档壳层 ═══
   文档头（状态 / 标题 / 署名 / tldr）+ 按 PLAN_MODEL.sections 顺序
  ...
  return (
    <div className="doc-wrap doc" id="docText">
      <div className="doc-flag">
        ...
        <span className="tag">plan 固定 {PLAN_MODEL.sections.length} 节 · 核心决策在 §3</span>
      </div>
