/* ═══ Spec Plan — 演示数据（会话 / 历史 / 命令）═══
   会话 / 历史仍为 mock 演示内容；批注已切到后端（annotations，见 review-net.jsx）。
   · 会话 / 消息   → 你的会话存储
   · 历史 HIST0    → 你的版本记录 */
...
/* 批注（annotations）与高亮锚点已切到后端：GET/POST /api/sessions/:id/annotations，
   渲染高亮由 App 从 annotation.anchor 派生 window.NOTE_HIGHLIGHTS（见 review-net.jsx /
   review-app.jsx）；此处不再保留 NOTES0 / NOTE_ANCHORS，避免与后端双源冲突。 */
